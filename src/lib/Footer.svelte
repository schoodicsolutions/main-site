...
<footer class="text-center border-gray-300 border-t">
	<div class="inner">
		<div
			class="flex flex-col lg:flex-row justify-center lg:items-start gap-10 md:gap-20 xl:gap-40 py-12 h-full max-w-screen-2xl mx-auto"
		>
			<section
				class="footer flex flex-col items-center lg:items-start gap-1 lg:gap-4 p-0 max-w-none"
			>
				<a href="/" class="navlink">
					<span class="a11y-hidden">Back to top</span>
					<div aria-hidden={true}><Logo variant="normal" size="medium" /></div>
				</a>
				<div>
					<p>Built with ❤️ in Washington County, Maine</p>
				</div>
				<div class="flex gap-2">
					<a href="https://www.facebook.com/schoodicsolutions"
						><SocialIcons network="facebook" bgColor="black" width={24} height={24} /></a
					>
					<a href="https://www.linkedin.com/company/schoodic"
						><SocialIcons network="linkedin" bgColor="black" width={24} height={24} /></a
					>
					<a href="https://www.github.com/schoodicsolutions"
						><SocialIcons network="github" bgColor="black" width={24} height={24} /></a
					>
				</div>
			</section>
			<section class="flex flex-col items-center gap-1 lg:gap-4 p-0">
	...
	<div class="border-gray-300 border-t py-3 px-4">
		...
		<a class="text-black" href="/terms-and-conditions">Terms and Conditions</a>
	</div>
</footer>
