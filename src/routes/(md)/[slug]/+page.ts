...
export async function load({ params, url }: { params: Record<string, string>, url: URL }) {
     ...
     if (params.slug.slice(0, cityPrefix.length) === cityPrefix) {
          ...
          const metadata: Metadata = {
               ...
               description: `Schoodic Solutions offers custom web design, development, and software solutions in ${city}, Maine. We help businesses grow online! Maine Web Design Since 2023. Schoodic Solutions Is Your #1 Company for Local Web Design. Located in Calais, Maine.`,
