...
export function load({ url }: { url: URL } ) {
    const meta: Metadata = {
        description: 'Schoodic Solutions offers custom web design, development, and software solutions in Washington County, ME (Portland, Belfast, Camden). We help businesses grow online!',
